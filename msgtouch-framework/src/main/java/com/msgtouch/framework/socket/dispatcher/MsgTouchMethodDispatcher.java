...
import com.msgtouch.framework.socket.annotation.MsgEntity;
import com.msgtouch.framework.socket.annotation.MsgParamter;
...
public class MsgTouchMethodDispatcher {
    ...
    public void addBilingMethod(String cmd,MsgTouchMethodInvoker invoker){
        if(methodInvokerMap.containsKey(cmd)){
            logger.warn("Rpc method has exists:cmd={}",cmd);
            return;
        }
